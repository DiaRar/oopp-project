...
public class ParticipantTest {
    ...
    public void checkConstructor() {
        Participant participant = new Participant("1", "John", "Doe", "j.d@email.com");
        assertEquals("John", participant.getFirstName());
        assertEquals("Doe", participant.getLastName());
        assertEquals("1", participant.getUuid());
        assertEquals("j.d@email.com", participant.getEmail());
    }

    @Test
    public void equalsHashCode() {
        Participant participant1 = new Participant("1", "John", "Doe", "j.d@email.com");
        Participant participant2 = new Participant("1", "John", "Doe", "j.d@email.com");
    ...
    public void notEqualsHashCode() {
        Participant participant1 = new Participant("1", "John", "Doe", "j.d@email.com");
        Participant participant2 = new Participant("2", "John", "Doe", "j.d@email.com");
    ...
    public void hasToString() {
        String string = new Participant("1", "John", "Doe", "j.d@email.com").toString();
