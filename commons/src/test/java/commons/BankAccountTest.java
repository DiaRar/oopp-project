...
public class BankAccountTest {
    ...
    @Test
    public void equalsOnlyIbanTest() {
        BankAccount ba1 = new BankAccount("IBAN1");
        BankAccount ba2 = new BankAccount("IBAN2");
        ...
        BankAccount ba3 = new BankAccount(ba1.getIban());
    ...
    @Test
    public void hashCodeOnlyIbanTest() {
        BankAccount ba1 = new BankAccount("IBAN1");
        BankAccount ba2 = new BankAccount("IBAN2");
