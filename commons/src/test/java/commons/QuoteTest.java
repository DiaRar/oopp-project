...
public class QuoteTest {
	...
	private static final Participant SOME_PARTICIPANT = new Participant("John", "j.d@email.com");
	...
	public void equalsHashCode() {
		var a = new Quote(new Participant("John", "j.d@email.com"), "c");
		var b = new Quote(new Participant("John", "j.d@email.com"), "c");
		assertEquals(a, b);
	...
	public void notEqualsHashCode() {
		var a = new Quote(new Participant("John", "j.d@email.com"), "c");
		var b = new Quote(new Participant("John", "j.d@email.com"), "d");
		assertNotEquals(a, b);
